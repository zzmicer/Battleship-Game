package com.example.battleship.ui.stat
...
import com.example.battleship.ui.login.LoginActivity.Companion.id
...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firebaseUser = FirebaseSource.currentUser()!!

        storage = FirebaseStorage.getInstance()
        storageRef = storage.reference

        databaseReference =
            FirebaseSource.database.getReference(FirebaseSource.PLAYERS_TABLE).child(id)
